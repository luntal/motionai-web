...
export const uiElementDescriptions = {
  ...
  'Eingewöhnung': {
    ...
    Nacheinander: 'Bezieht sich auf die Reihenfolge in der die Kreise berührt werden müssen. Bevor die Punktliste in ein Preset gespeichert wird, kann die Bewegungslogik hier ausgewählt werden. Unabhängig: Die Kreise können für die linke und rechte Hand unabhängig voneinander berührt werden. Nacheinander: Die Kreise müssen für die linke und rechte Hand nacheinander berührt werden, so wie sie beim Erstellen des Presets angeklickt wurden. Gleichzeitig: Die Kreise müssen für die linke und rechte Hand gleichzeitig berührt werden. Hier macht es Sinn für linke und rechte Hand die selbe Anzahl an Kreisen auszuwählen.',
    HandBearbeiten: 'Diese Auswahl bestimmt, ob der nächste Kreis für die linke oder rechte Hand gesetzt wird. Bei Auswahl "Auto" werden Kreise im linken Bereich automatisch der linken Hand und Kreise im rechten Bereich automatisch der rechten Hand zugeordnet. Bei Auswahl "Links" oder "Rechts" werden alle Kreise der linken oder rechten Hand zugeordnet.',
